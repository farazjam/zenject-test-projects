...
namespace Cube.MiniGame.Systems
{
    ...
    public class HurdleSpawner : IInitializable, IDisposable, IGameSystem
    {
        private bool _isActive;
        private HurdleBlock.HurdleBlockPool _pool;
        ...
        public HurdleSpawner(HurdleBlock.HurdleBlockPool pool, SignalBus signalBus, CubeGameData data)
        {
            _pool = pool;
        ...
        public void Initialize()
        {
            ...
            _spawnInterval = _data.hurdle.SpawnInterval;
        }
        ...
        {
            if (args.toucherType == BlockType.Hurdle) _pool.Despawn((HurdleBlock)args.toucherBlock);
        }
    }
}